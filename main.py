...
dir_men = r"C:\Users\gsutk\Desktop\Projects\LoveSolutions\men.csv"
dir_women = r"C:\Users\gsutk\Desktop\Projects\LoveSolutions\women.csv"
wdir = r""
if(sex.lower()=="w"):
...
new_value = []
topfive = []
print("In the next steps, your age and interests will be asked. No need to mention the obvious, for age part you will type your age. For the each interest you'll be asked, you must rate your level of interest from 1 to 100.")
k = 5
